...
class SARSA(object):
    ...
    def train(self, num_epoch):
        # Resulted list for the plotting
        steps = []
        all_costs = []
        accuracy = []
        Reward_list = []
        ...
        for i in range(num_epoch):
            ...
            while True:
                ...
                next_action = self.epsilon_greedy_policy(str(next_observation))
                ...
                new_Q, self.history = self.learn(str(observation), action, reward, str(next_observation),next_action)
                ...
                # update the action and observation
...
if __name__ == '__main__':
    ...
    # print q table
    SARSA.print_q_table('Q-table_sarsa.txt')
